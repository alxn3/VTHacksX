                ...
                <div className="flex flex-col items-center justify-center min-h-full gap-16 py-20 md:gap-5 md:flex-row">
                    ...
                    <div className="z-10 flex flex-row md:flex-1 md:flex-col md:h-full max-h-[calc(100vh-7em)] ml-20">
                        <div className=" text-right py-10">
                            <h2 className='text-[1.3em] text-sky-400'>Artscaper is created by Artists, for Artists.</h2>
                            <br />
                            <p>We believe that art is an intrinsic human gift, one that should be created and enjoyed by anyone and everyone.</p>
                            <br />
                            <p>However, we&apos;ve found that with the expansion of the internet, digital resources, and new techologies,
                                the art world has become more and more difficult to navigate.
                                Consistently, we have heard our artist friends asking:
                                <br />
                            </p>
                            <ul className="list-disc list-inside py-10 leading-relaxed">
                                <p className='text-green-500'>&quot;What art resource is the best?&quot;</p>

                                <p className='text-blue-400'>&quot;How do I get my art noticed?&quot;</p>

                                <p className='text-sky-400'>&quot;Why can&apos;t I find a good reference?&quot;</p>

                                <p className='text-violet-400 text-[2em]'>&quot;How do I start?&quot;</p>
                            </ul>
                            <p>We hope Artscaper can become a central hub of art tools for you to find tailored resources, build your brand presence, and find community networks
            ...
            <div className="my-24 text-center md:text-left h-full">
                ...
                <div className="md:grid grid-cols-[3fr_2fr] items-center gap-20 space-y-10 md:space-y-0 mt-10">
                    <p>
                        ...
                        <br /> */}
                        <p className="italic">
                        &quot;Hi, I am an engineering student and a self-taught photographer and&nbsp; 
                            <a className='text-blue-400 hover:text-blue-700 transition 300'
                            ...
                            .
                            <br />
                            I have been visualizing Artscaper for the past year, and hope realize it soon to help other artists solve the same problems
                            I faced while navigating the digital art world.&quot;</p>
                    </p>
                ...
                <div
                        className="w-3/6 mx-auto md:w-full"
                    >
                        ...
                        <br /> */}
                    <p className="italic">
                    &quot;Hey there, I&apos;m a full-stack developer and friend of @fmeng__. I&apos;m excited to be working on this project with him, and I hope to help make Artscaper a reality!&quot;
                    </p>
                    
                </div>

                <div className="md:grid items-center gap-10 space-y-10 md:space-y-0 text-center mt-20">
                        <h2 className='text-[1.3em] text-sky-400'>Interested in joining the team?</h2>
                        
                        <p>Send us an email at <a className='text-blue-400 hover:text-blue-700 transition 300' href="mailto:contact@artscaper.net">contact@artscaper.net </a>
